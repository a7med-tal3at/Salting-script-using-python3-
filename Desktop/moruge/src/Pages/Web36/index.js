                                        ...
                                        <div className="with-visa p-3">
                                            <div className="row">
                                                ...
                                                <div className="col-md-8 position-relative">
                                                    <input type="text" className="p-2 my-3 w-100" placeholder="3333*********" />
                                                    <i className="fa fa-cc-visa fa-lg position-absolute main-c"></i>
                                                </div>
                                                <div className="col-md-3 text-right pt-3">
                                                    <a href="#" className="visa-det">اظهار التفاصيل</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="with-out">
                                            <div className="row">
                                                ...
                                                <div className="col-md-8 px-5 mb-3">
                                                    <input type="text" className="p-2 w-100" placeholder="3333*********" />
                                                </div>
                                                <div className="col-md-8 px-5 mb-3">
                                                    <input type="text" className="p-2 w-100" placeholder="3333*********" />
                                                </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-7 visa-date text-right">
                                                    <input className="rounded p-2" type="text" placeholder="5" />
                                                    <input className="rounded p-2" type="text" placeholder="5/5" />
                                            ...
                                            <div className="row">
                                                <div className="col-6 pt-3">
                                                    <p className="fw-bold"> رمزالتحقق من البطاقة[ CCV ]</p>
                                                </div>
                                                <div className="col-6 visa-date text-right">
                                                    <input className="rounded p-2" type="text" placeholder="5/5" />
                                                    <i className="fa fa-question-circle"></i>
                                                </div>
