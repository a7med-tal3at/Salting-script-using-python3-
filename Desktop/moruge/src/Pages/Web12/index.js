                            ...
                            <form>
                              <div className="form-group mb-5">
                                ...
                                <div className="d-flex">
                                  <input type="text" value="3" className="form-control w-75" />
                                  <span className="fw-bold text-secondary mx-3">ساعات</span>
                                </div>
                              </div>
                              <div className="form-group mb-5">
                                ...
                                <div className="d-flex">
                                  <input type="text" value="3" className="form-control w-75" />
                                  <span className="fw-bold text-secondary mx-3">طالب</span>
                                </div>
                              </div>
                              <div className="d-flex">
