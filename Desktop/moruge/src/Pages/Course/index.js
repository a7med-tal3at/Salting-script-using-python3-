      ...
      <>
        ...
        <div className="gap"></div>
          <div className="drop-cont shadow sec-bg rounded p-5 w-75 position-absolute">
            <div className="drops row">
              ...
              <div className="col-md">
                <input type="text" className="w-100 h-75 px-3" placeholder="اسم الكورس" />
              </div>
            </div>
        ...
        <div className="container">
          <div className="sec-hello mt-5 text-center">
            ...
            <h5 className="w-100 fw-bold sec-title center-after">شركاء النجاح</h5>
          </div>
          <div className="d-flex mx-auto" style={{width: "fit-content"}}>
            <img src={partImg} style={{width: "170px"}} alt="" />
            <img src={partImg} style={{width: "170px"}} alt="" />
            <img src={partImg} style={{width: "170px"}} alt="" />
            <img src={partImg} style={{width: "170px"}} alt="" />
            <img src={partImg} style={{width: "170px"}} alt="" />
          ...
          <div className="sec-hello mt-5 text-center">
            <h5 className="w-100 fw-bold sec-title center-after mb-5">الاكثر شيوعا بين الطلاب</h5>
          </div>
          <div className="c-cards row">
            <CourseCard name="اساسيات علوم الحاسب" time="12" rate="120" price="200" univers="جامعة الملك فهد" />
            <CourseCard name="اساسيات علوم الحاسب" time="12" rate="120" price="200" univers="جامعة الملك فهد" />
            <CourseCard name="اساسيات علوم الحاسب" time="12" rate="120" price="200" univers="جامعة الملك فهد" />
            <CourseCard name="اساسيات علوم الحاسب" time="12" rate="120" price="200" univers="جامعة الملك فهد" />
          </div>
