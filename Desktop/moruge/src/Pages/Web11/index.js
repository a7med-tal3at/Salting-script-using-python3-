                        ...
                        <div className="row w-100">
                          <div className="col-md bg-light p-3 text-right">
                            <div className="d-flex justify-content-between">
                              ...
                              <span className="step text-white bg-secondary rounded-circle text-center">2</span>
                              <span className="le"></span>
                              <span className="step text-white bg-secondary rounded-circle text-center">3</span>
                            </div>
                            <h4 className="main-c my-5">الخطوة الاولي</h4>
                            <form>
                              <div className="form-group mb-5">
                                <label>المادة التي تقوم بحجزها</label>
                                <input type="text" value="الرياضيات" className="form-control" />
                              </div>
                              <div className="form-group mb-5">
                                <label>متي تريد ان تبدا الحصة</label>
                                <input type="text" value="15-5-2020" className="form-control" />
                              </div>
