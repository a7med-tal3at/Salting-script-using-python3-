              ...
              <div className="col-md-8">
                ...
                <div className="inst-requests">
                  <div className="row shadow my-5 mr-3 bg-white rounded position-relative h-25" style={{padding: "10px", marginRight: "2px!important"}}>
                    ...
                    <div className="col-md-5 text-center fw-bold text-white d-flex justify-content-between">
                      <div>
                        ...
                        <div>
                            <button className="btn therd-bgc text-white">قيد الانتظار</button>
                      </div>
                    </div>
                    ...
                    <div className="col-md-5 text-center fw-bold text-white d-flex justify-content-between">
                        <div>
                            <button className="btn btn-primary text-white">
                                <i className="fa fa-long-arrow-right"></i>  بدأ الان
                            </button>
                        </div>
                        <div>
