                  ...
                  <div className="shadow bg-white rounded p-3 mb-5 bg-white">
                    <div className="container">
                      <p className="text-center fw-bold my-3">
                        اهلا بك عزيزي الطالب <span className="main-c">{this.props.name}</span> في منصة بروج
                      </p>
                      <div className="row text-center">
                        <div className="col-md">
                          <p className="fw-bold">رصيد حسابك الان <span className="main-c">500</span> دينار سعودي</p>
                        </div>
                        <div className="col-md">
                          <a href="#" className="btn main-bgc text-white fw-bold">شحن رصيدك</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md">
                        ...
                        <div className="d-flex justify-content-between">
                          <div className="clock">
                            <div className="sqr text-white text-center fw-bold main-bgc ">0</div>
                            <p>الثانية</p>
                          </div>
                          <div className="clock">
                            <div className="sqr text-white text-center fw-bold main-bgc ">0</div>
