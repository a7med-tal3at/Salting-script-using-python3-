              ...
              <div className="col-md-8 sec-bg p-5">
                <div className="std-wel shadow bg-white p-3">
                    <h5 className="text-center text-secondary fw-bold">
                        اهلا بك عزيزي الطالب <span className="main-c">علي</span> في منصة مروج
                    </h5>
                    <div className="d-flex justify-content-between mt-5 ">
                        <h5 className="fw-bold">
                            رصيد حسابك الان <span className="main-c"> 500 ريال سعودي</span>
                        </h5>
                        <button className="btn main-bgc text-white ">شحن رصيدك</button>
                    </div>
                </div>
                ...
                <div className="row std-lect shadow bg-white p-3 ">
                    <div className="col-md-4 text-right">
                        <h6 className="fw-bold">المادة:<span className="main-c">رياضيات</span></h6>
                        <h6 className="fw-bold my-3">المعلم:<span className="main-c">احمد محمد علي</span></h6>
                        <h6 className="fw-bold">مدة الحصة:<span className="main-c">3 ساعات</span></h6>
                    </div>
