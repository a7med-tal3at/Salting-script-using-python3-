                ...
                <div className="row">
                    ...
                    <div className="col-md-8 sec-bg p-3">
                        <div className="d-flex p-3 w-50 mx-auto">
                            <Link to="/web29" className="btn main-bgc text-white">المعلومات الشخصية</Link>
                            <Link to="/web47" className="btn btn-secondary">الشهادات الدراسية</Link>
                        </div>
                        ...
                        <div className="row justify-content-between">
                            <div className="col-md-5">
                                ...
                                <PersonalInfo name="البريد الاليكتروني" val={this.state.email} />
                                <PersonalInfo name="المواد التي ادرسها" val={this.state.subjects_he_teach} />
                                <div className="d-flex mb-5">
                                    <div className="p-3 main-bgc text-white fw-bold rounded mx-2 ">رياضيات</div>
                                    <div className="p-3 main-bgc text-white fw-bold rounded mx-2 ">احصاء</div>
                                    <div className="p-3 main-bgc text-white fw-bold rounded mx-2 ">جبر</div>
                                </div>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className="py-3">
                                                    <span className="p-2 text-right rounded fw-bold bg-white">100</span>
                                                </td>
                                                <td>
                            ...
                            <div className="col-md-5">
                                <div className="my-3">
                                    <PersonalInfo name="المؤهل" val={this.state.educational_qulifictions} />
                                </div>
                                ...
                                <textarea className="w-100 h-25 border-0 p-3" >{this.state.about}</textarea>
                                <div className="w-50">
