          ...
          <section className="profile-content">
            <div className="container">
              ...
              <div className="col-md-8">
                <div className="row">
                  <div className="col d-flex sec-bg mr-3 rounded" style={{padding: "10px"}}>
                ...
                <div className="row shadow my-5 mr-3 bg-white rounded" style={{padding: "10px", marginRight: "2px!important"}}>
                  <div className="col-md-3">
                  ...
                  <div className="col-md-6 text-right">
                    ...
                    <span className="job fw-bold text-secondary" style={{fontSize: "12px"}}>معلم لغة عربية</span>
                  ...
                  <div className="col-md-3">
                    <button  className="btn btn-success btn-block mb-3"><i className="fa fa-play"></i> مشاهدة</button>
                    <button  className="btn btn-success btn-block mb-3">تفاصيل الحصة</button>
                  </div>
                </div>
                ...
                <div className="row shadow my-5 mr-3 bg-white rounded" style={{padding: "10px", marginRight: "2px!important"}}>
                  ...
                  <div className="row w-100" style={{padding: "5px", marginRight: "2px!important"}}>
                    <div className="col text-center main-c">
                      <i className="text-secondary fa fa-print" aria-hidden="true"></i> طباعة
                      <span className="mx-3 text-dark">او</span>
                      <i className="text-secondary fa fa-share-alt" aria-hidden="true"></i> مشاركة
                    </div>
                  </div>
                </div>
