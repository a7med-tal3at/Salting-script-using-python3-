...
class Web37 extends Component {
    render() {
        return (
            <>
                <h3 className="hd-title text-center mt-5 main-c">تفاصيل الحصة الخاصة بك</h3>
                        ...
                        <div className="row">
                            <div className="col-md-4 ml-3">
                                <div className="col-container sec-bg p-3">
                                    ...
                                    <div className="copon-code d-flex">
                                        ...
                                        <button className="btn text-white mr-2 fw-bold main-bgc">تفعيل</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-7 sec-bg p-3">
                                ...
                                <div className="pay-sec d-flex justify-content-center">
                                    <div className="card mx-3 p-3 bg-white">
                                    ...
                                    <button className="btn main-bgc text-white card mx-3">التحويل البنكي</button>
                                </div>
                                <h5 className="fw-bold text-center my-5" style={{fontSize: "15px"}}>يمكنك التحويل علي احد حساباتناالتالية</h5>
                                <div className="row">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" className="main-c" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <h5 className="cell-name text-right"> اسم صاحب الحساب</h5>
                                                    </td>
                                                    <td>
                                                        <input type="text" className="main-c" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h5 className="cell-name text-right">رقم الايداع</h5>
                                                    </td>
                                                    <td>
                                                        <input type="text" className="main-c" />
                                                    </td>
                                ...
                                <h5 className="cell-name text-center w-50 mx-auto my-5">
                                    بعد التحويل يرجي ارفاق الصور والتحويل و اسم صاحب المحول منة وسيتم تخزين البيانات   
                                </h5>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <label className="pt-2" for="imp-img">تحميل</label>

                                        <input type="file" id="imp-img" className="d-none" />
                                    </div>
                                    <button className="btn main-bgc text-white d-block mx-auto my-5">ارسال</button>
                                </div>
                            </div>
