        ...
        <>
          <div className="ov-lay d-none">
            <div className="w-75 h-75 p-5 bg-white rounded" >
                ...
                <p className="text-secondary fw-bold text-center" >من فضلك اختر طريقة السحب المناسبة لك</p>
                <div className="d-flex  justify-content-center my-5 ">
                  <button onClick={this._BankTrans} className="pay-method btn mr-3 main-bgc text-white fw-bold">التحويل البنكي</button>
                  <button onClick={this._OutTrans} className="pay-method btn mr-3 bg-secondary text-white fw-bold">التحويل الخارجي</button>
                  <button onClick={this._WestrenUnion} className="pay-method btn mr-3 bg-secondary text-white fw-bold">Western union</button>
                  <button onClick={this._PayPal} className="pay-method btn mr-3 bg-secondary text-white fw-bold">PayPal</button>
                </div>
                  
                <this.handelUi />
                <button className="btn main-bgc fw-bold text-white d-block my-5 mx-auto" onClick={ this.showControlers }>تاكيد  الطلب</button>
            </div>
          </div>
          <Completed />
          ...
          <section className="profile-content">
            <div className="container">
              <div className="row">
                ...
                <div className="res-0 d-flex sec-bg mr-3 rounded" style={{padding: "10px"}}>
                  ...
                  <div className="col-md">
                    <button onClick={this.hideControlers} className="btn main-bgc fw-bold text-white">شحن المحفظة</button>
                  </div>
                </div>
                <div className="inst-requests">
                  ...
                  <div className="row shadow my-5 mr-3 bg-white rounded position-relative h-25" style={{padding: "10px", marginRight: "2px!important"}}>
                    ...
                    <div
                    className="col-md-12 row text-right mx-auto my-3">
                      <div className="col-md">
                      ...
                      <div className="col-md-4">
                        <label style={{fontSize: "12px"}}>عدد الساعات المدفوعة: </label>
