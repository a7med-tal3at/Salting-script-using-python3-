    ...
    return (
      ...
      <section className="signin sec-bg mb-5">
        <div className="container text-center mt-5 py-5">
          ...
          <h1 className="sec-title text-center mx-auto center-after fw-bold"> معلومات بطاقةالدفع الخاصة بك</h1>
          <form method="post">
            <div className="row">
              <div className="col-md">
                <div className="form-row">
                  <div className="form-group col">
                    <input type="text" className="p-3 w-75" placeholder="اسم حامل البطاقة" />
                ...
                <div className="form-row">
                  <div className="form-group col">
                    <input type="text" className="p-3 w-75" placeholder="رقم الCCV" />
                    <i className="fa fa-check-circle"></i>
                  </div>
                </div>
              </div>
              <div className="col-md">
                ...
                <div className="form-row">
                  <div className="form-group col">
                    <a href="#" className="btn main-bgc fw-bold text-white p-3 w-75">تأكيد و دخول الي الملف الشخصي</a>
                    <i className="fa fa-check-circle"></i>
                  </div>
                </div>
              </div>
            </div>
            <a href="#" className="text-dark">تخطي <i className="fa fa-long-arrow-left text-dark"></i></a>
          </form>
        </div>
      </section>
