        ...
        return (
          <section className="profile-home main-bgi py-5 ">
            <div className="container position-relative text-center">
              <h3 className="sec-title fw-bold text-white mx-auto center-after white-after" style={{width: "fit-content"}}>
                مرحبا بك <span className="therd-c">معلم {this.props.name}</span> في منصة مروج
              </h3>
              ...
              <div className="main-info position-absolute">
                <img src={img} className="mr-pro-img" alt="" />
                <div className="stars">
                  <Stars rate="5" />
                </div>
