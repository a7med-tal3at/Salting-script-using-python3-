      ...
      <div className="container-fluid ">
        <div className={this.handelSearch(this.props.class)}>
          <div className="drops row ">
            <div className="col-sm">
              <div className="dropdown">
                <button  className="btn dropdown-toggle w-100 mb-3 py-3 px-3" style={{background: "#e9fffd"}} type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  اختر المرحلة ...
                </button>
          ...
          <div className="search-btn">
            <Link to='/profiles' className="btn px-5 position-absolute main-bgc">
